...
const Register = () => {
    ...
    const handleSubmit = async (e:any) => {
        ...
        try {
            ...
            //console.log(response?.accessToken); TO CHECK!!!!!!!
            ...
            {success ? (
                ...
                <section className="regSection">
                    ...
                    <form onSubmit={handleSubmit}>
                        <label id= "regLabel" htmlFor="username">
                            Username:
                        ...
                        <label id= "regLabel" htmlFor="password">
                            Password:
                        ...
                        <label id= "regLabel" htmlFor="confirm_pwd">
                            Confirm Password:
                        ...
                        <button className="regButton" disabled={!validName || !validPwd || !validMatch ? true : false}>Sign Up</button>
                    </form>
                    <p className="regP">
